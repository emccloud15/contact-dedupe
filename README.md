...
```
## Configuration
The configuration file required to run this tool is a yaml file which includes the field names to be used to find duplicates, as well as some other customizable settings.  
